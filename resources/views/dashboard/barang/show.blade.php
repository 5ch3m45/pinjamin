                                    ...
                                    <div id="img-viewer" class="row" style="max-width: 1024px">
                                        @if($barang->fotos)
                                            ...
                                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 d-flex flex-column mb-3">
                                                ...
                                                <button class="btn btn-block btn-danger hapus-foto-barang" data-barang-id="{{ $barang->id }}" data-id="{{ $foto->id }}"><i class="bi bi-trash"></i></button>
                                            </div>
                                            @endforeach
                                        @endif
                                    </div>
